...
Write-Host "Installing Traffic Pipeline dependecies:" -ForegroundColor Yellow
Write-Host "- cmake"
. ".\cpp\Data-Analysis\shell_utils\pwsh\install_cmake.ps1"
Write-Host "- Python3 (snakemake)"
. ".\cpp\Data-Analysis\shell_utils\pwsh\install_python.ps1"
Write-Host "- g++ (> 4.9)"
Write-Host "- make"
. ".\cpp\Data-Analysis\shell_utils\pwsh\install_g++.ps1"
Write-Host "- Chocolatey (recommended)"
. ".\cpp\Data-Analysis\shell_utils\pwsh\install_choco.ps1"
Write-Host "- SublimeText3 (recommended)"
. ".\cpp\Data-Analysis\shell_utils\pwsh\install_sublimetext3.ps1"
Write-Host "- Ninja"
. ".\cpp\Data-Analysis\shell_utils\pwsh\install_ninja.ps1"
...
ElseIf($pyver -like "*2.*" -Or $pyver -like "*Anaconda 2.*") {
    ...
    Else{
        $CONFIRM = Read-Host -Prompt "Do you want install a new Python version, snakemake and other dependecies? [y/n]"
        If($CONFIRM -eq 'N' -Or $CONFIRM -eq 'n') { Write-Host "Abort" -ForegroundColor Red }
...
Write-Host "Build Traffic Pipeline with cmake-ninja" -ForegroundColor Yellow
& .\build.ps1
